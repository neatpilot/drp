...
<script type="text/javascript">
	...
	function selectAimClient(index) {
		window.open('${pageContext.request.contextPath}/flowcard/aim_client_select.jsp?index=' + index, '请选择需方客户', 'width=700, height=400, scrollbars=no');
	}

	function selectItem(index) {
		window.open('${pageContext.request.contextPath}/flowcard/item_select.jsp?index=' + index, '请选择物料', 'width=700, height=400, scrollbars=no');
	}
			...
			<form name="flowCardAddForm" method="post" action="${pageContext.request.contextPath}/servlet/flowcard/FlowCardServlet">
				...
				<p>
					<input name="btnAddLine" type="button" id="btnAddLine"
						onClick="addOneLineOnClick()" value="加入一行">
